...
public class SignalFrimework {
	...
	/****** Calculate Shanonn Entropy ******/ 
	 @SuppressWarnings("boxing")
	  ...
	  public void ShowAll(final double[] kovariation) {
	...
	// finds the max and its index
	    ...
	    public static double[] optimizedPrintKMax(double arr[], int n, int k)
	    {
	        int i, j;
	...
	/***** Calculating Curvature *****/
	 ...
	 public void CurvtureCalc(final double[][] PCA, final double[] curveature) {
